...
function Basic_info() {
    ...
    return (
   <section className="Basic_info my-6 p-6 border border-gray-300  dark:border-gray-700 rounded-lg">
                ...
                <p> Provide essential details about your solution</p>
                    <div className="my-4">
                        ...
                        <input 
                        className="w-full border border-gray-300 dark:border-gray-700 p-2 rounded-lg" 
                    ...
                    <div className="mb-4 flex gap-20">
                        ...
                        <div className="flex flex-col">
                            ...
                            <select {...register("difficulty")} name="difficulty" className="block w-40 border border-gray-300 dark:border-gray-700 bg-white dark:bg-slate-900 text-gray-900 dark:text-white rounded-md shadow-sm px-3 py-2">
