...
function CodeSnippets() {
  ...
  return (
    <section className="my-6 p-6 border border-gray-300 rounded-lg">
          <div className="flex justify-between items-center mb-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 border border-gray-300 rounded-lg hover:bg-slate-100 cursor-pointer px-3 py-1 "
            >
          ...
          {fields.map((field, index) => (
            <div key={field.id} className="border border-dashed border-gray-300 rounded-xl p-6 mb-3">
