    ...
    <section className="Basic_info my-6 p-6 border border-gray-300 dark:border-gray-700 rounded-lg">
      ...
      <div className="mb-4 flex flex-col gap-4 lg:flex-row lg:gap-20">
        <div className="flex flex-col">
          ...
          <select
            {...register('status')}
            className="block w-40 border border-gray-300 dark:border-gray-700 bg-white dark:bg-slate-900 text-gray-900 dark:text-white rounded-md shadow-sm px-3 py-2"
          >
